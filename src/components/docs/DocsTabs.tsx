...
import { LockKeyhole, Maximize, Code2 } from "lucide-react";
...
export default function DocsTabs({ tab, setTab, isPremium, hasAccess }: Props) {
  return (
        ...
        return (
          ...
          >
            ...
            <span className="relative z-10">
              {t === "preview" && <Maximize size={13} strokeWidth={2.5} />}
