...
const FeaturesGrid: React.FC = () => {
  return (
    <section
      id="components"
      className="relative isolate overflow-hidden bg-gradient-to-b from-white/20 to-[125%] pt-10 ring-1 ring-gray-900/5 sm:pt-32 dark:from-gray-500/20 dark:ring-gray-950/5"
      style={{
