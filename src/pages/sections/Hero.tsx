...
const Hero: React.FC = () => {
  ...
  return (
    <section className="my-16 px-4">
      {/* main header - SEO: Using <div> instead of <h3> for badges is better for outline hierarchy */}
      ...
      <div className="py-8">
        {/* SEO FIX: Removed nested <h1>. Only one <h1> should exist, and it shouldn't contain another <h1> */}
      ...
      <div className="flex flex-col lg:flex-row max-w-4xl my-16 mx-auto items-center justify-between gap-10">
        <div className="space-y-5 text-neutral-500 dark:neutral-400 text-center lg:text-left">
